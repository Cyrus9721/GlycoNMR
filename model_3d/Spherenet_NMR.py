...
class init(torch.nn.Module):
    def __init__(self, num_radial, hidden_channels, act=swish, use_node_features=True, in_embed_size=560):
        super(init, self).__init__()
        self.act = act
        self.use_node_features = use_node_features
        if self.use_node_features:
#             self.emb = Embedding(95, hidden_channels)
            self.emb = Linear(in_embed_size, hidden_channels)
...
class SphereNet(torch.nn.Module):
    ...
    """
    def __init__(
        self, energy_and_force=False, in_embed_size =560, cutoff=5.0, num_layers=4,
        ...
        self.init_e = init(num_radial, hidden_channels, act, use_node_features=use_node_features, in_embed_size=in_embed_size)
