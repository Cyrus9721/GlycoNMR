...
class SchNet(torch.nn.Module):
    ...
    """
    def __init__(self, energy_and_force=False, cutoff=10.0, num_layers=6, hidden_channels=128, out_channels=1, num_filters=128, num_gaussians=50, in_embed_size=560):
...
#         self.init_v = Embedding(100, hidden_channels)
        self.init_v = nn.Linear(in_embed_size, hidden_channels)
