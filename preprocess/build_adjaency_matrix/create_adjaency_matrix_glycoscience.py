...
class build_adjacency_matrix:
    def __init__(self, labeled_pdb_dir='glycosciencedb/data/',
                 out_adjacency_dir='glycosciencedb/adjaency_matrix/connection/',
                 out_interaction_dir='glycosciencedb/adjaency_matrix/interaction/', threshold_carbon=1.65,
